...
import com.action.system.mapper.SysScheduleTaskMapper;
import com.action.system.service.ISysScheduleTaskService;
import com.action.system.struct.converter.ScheduleTaskConverter;
...
public class ISysScheduleTaskServiceImpl extends ServiceImpl<SysScheduleTaskMapper, SysScheduleTask> implements ISysScheduleTaskService {
    ...
    public boolean shutdownAllTask() {
        ...
        //修改状态
        return update(Wrappers.<SysScheduleTask>lambdaUpdate().set(SysScheduleTask::getStatus, StatusType.DISABLED.getStatus()));
    }
