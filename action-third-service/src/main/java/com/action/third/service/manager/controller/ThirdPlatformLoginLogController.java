...
public class ThirdPlatformLoginLogController implements BaseController<IThirdPlatformLoginLogService, ThirdPlatformLoginLog> {
    ...
    /**
     * @param thirdPlatformLoginLog 第三方平台信息对象
     * @Description: 保存第三方平台登录日志
     * @return: Result 结果集
     * @throws:
     * @Author: ljf  <lin652210786@163.com>
     * @Date: 2024/05/31
...
//    @PreAuthorize("@ss.hasPerm('sys:test:save')")   // 开启注解权限时生效
    ...
    public Result save(@RequestBody ThirdPlatformLoginLog thirdPlatformLoginLog) {
        boolean isSave = iThirdPlatformLoginLogService.save(thirdPlatformLoginLog);
