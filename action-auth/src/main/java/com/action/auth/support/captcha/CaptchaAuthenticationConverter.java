...
import com.action.auth.util.OAuth2EndpointUtils;
...
public class CaptchaAuthenticationConverter implements AuthenticationConverter {
    ...
    public Authentication convert(HttpServletRequest request) {
        ...
        if (org.apache.commons.lang3.StringUtils.isBlank(captchaId)) {
            OAuth2EndpointUtils.throwError(
                    OAuth2ErrorCodes.INVALID_REQUEST,
        ...
        if (org.apache.commons.lang3.StringUtils.isBlank(captchaCode)) {
            OAuth2EndpointUtils.throwError(
                    OAuth2ErrorCodes.INVALID_REQUEST,
