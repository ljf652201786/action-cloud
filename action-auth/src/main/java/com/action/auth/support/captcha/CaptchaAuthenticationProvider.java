...
public class CaptchaAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        Object o = redisCacheServices.get(RedisConstants.CAPTCHA_CODE_PREFIX + captchaId);
        if (Objects.isNull(o)) {
            throw new OAuth2AuthenticationException("验证码已失效");
        }
        String cacheCaptchaCode = o.toString();

        // 验证码比对
        if (!StringUtils.equals(cacheCaptchaCode, captchaCode)) {
