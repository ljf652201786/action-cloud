...
import com.action.auth.util.OAuth2AuthenticationProviderUtils;
...
public class SmsCodeAuthenticationProvider implements AuthenticationProvider {
    ...
    public SmsCodeAuthenticationProvider(
            ...
            ThirdDetailsService thirdDetailsService,
            RedisCacheServices redisCacheServices

    ) {
        Assert.notNull(authorizationService, "authorizationService cannot be null");
        Assert.notNull(tokenGenerator, "tokenGenerator cannot be null");
        Assert.notNull(thirdDetailsService, "userDetailsService cannot be null");
        Assert.notNull(redisCacheServices, "redisCacheHandle cannot be null");
        this.authorizationService = authorizationService;
        this.tokenGenerator = tokenGenerator;
        this.thirdDetailsService = thirdDetailsService;
        this.redisCacheServices = redisCacheServices;
    }
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (!code.equals("666666")) { // 666666 是后门，因为短信收费，正式环境删除这个if
            ...
            String cacheCode = (String) redisCacheServices.get(codeKey);
        ...
        // 根据手机号获取用户信息
        UserDetails userDetails = thirdDetailsService.getUserByPhone(mobile);
